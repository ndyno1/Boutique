(function () {
      ...
      <header class="vf-header" id="vfHeader">
        <div class="vf-header-container">
          <div class="vf-header-left">
            <button
              type="button"
              class="vf-menu-trigger-btn"
              aria-label="Menu"
              aria-expanded="false"
              aria-controls="vfSideMenu"
              data-vf-menu-trigger
            >
          ...
          <div class="vf-header-right">
            ...
            <a
              href="https://wa.me/243838694889"
              target="_blank"
              rel="noopener noreferrer"
              class="vf-btn-support"
            ...
            >
              ...
              <span class="vf-btn-support-text">Aide</span>
            </a>
          </div>
        </div>
      </header>
        ...
        <div class="vf-side-menu__body">
          <nav class="flex flex-col gap-1" aria-label="Navigation principale">
            ...
            <a href="/index.html" class="vf-menu-link" data-path="/index.html">
              <svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            ...
            <a href="/wallet.html" class="vf-menu-link" data-path="/wallet.html">
              <svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                <path d="M19 7H6a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h13a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2ZM16 7V5a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v2M20 12h-4a2 2 0 0 0 0 4h4"></path>
              </svg>
  ...
  function configureSearchBox() {
    ...
    if (searchContainer) {
      searchContainer.style.display = isHome ? "" : "none";
    }

    if (inputEl && box) {
      const syncPlaceholder = () => {
        box.style.opacity = inputEl.value.trim() ? "0" : "1";
      };
